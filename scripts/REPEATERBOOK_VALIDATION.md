...
### 🔴 Repeater appears off-air (1)

| Repeater ID | Location | Field | Ours | RepeaterBook | Note |
|-------------|----------|-------|------|-------------|------|
| `K4HYB-146.910` | Griffin | active | `true` | `false` | RepeaterBook status: Unknown |

### 🔴 Unknown callsign resolved (1)

| Repeater ID | Location | Field | Ours | RepeaterBook | Note |
|-------------|----------|-------|------|-------------|------|
| `n0call-147.135` | Milledgeville | callsign | `n0call` | `W4PCF` | RepeaterBook has a real callsign — update manually and set verified: true |
...
| [84](https://www.repeaterbook.com/repeaters/details.php?state_id=13&ID=84) | K4WOC | 146.74500- | Calhoun | 2026-06-24 |
...
| [19415](https://www.repeaterbook.com/repeaters/details.php?state_id=13&ID=19415) | WB4QOJ | 443.25000+ | Dallas | 2026-06-24 |
...
| [222](https://www.repeaterbook.com/repeaters/details.php?state_id=13&ID=222) | KR4CW | 147.33000+ | Toccoa | 2026-06-21 |
| [115](https://www.repeaterbook.com/repeaters/details.php?state_id=13&ID=115) | K4NRC | 145.11000- | Turin | 2026-04-16 |
...
|-------------|-------|---------|-----------|
| `K4HYB-146.910` | active | `True` | `False` |
...
*Next validation recommended: 2026-09-24 (quarterly)*
