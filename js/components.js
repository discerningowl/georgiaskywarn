 ...
 * Change-log:
 *   • 2026-04-02 – Removed sitewide search button and modal (search feature removed)
        ...
        <header class="header">
            <div class="header-content">
                <a href="index.html" class="logo">
                    <img src="assets/georgiaskywarnlogo.png" alt="Georgia SKYWARN Logo" class="logo-image">
                    <div class="logo-text">
                ...
                <div class="footer-grid">
                    ...
                    <div class="footer-section">
                        ...
                        <ul class="footer-nav">
                            ...
                            <li><a href="repeater-validation.html" style="opacity: 0.4;" aria-label="Repeater Database Validation">&#8943;</a></li>
                        </ul>
                    </div>
                </div>
